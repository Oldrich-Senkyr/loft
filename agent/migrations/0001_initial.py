    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('divisions', models.ManyToManyField(blank=True, to='agent.division')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('description', models.TextField(blank=True)),
                ('division', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='groups', to='agent.division')),
            ],
        ),
        migrations.CreateModel(
            name='Person',
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='persons', to='agent.company', verbose_name='Company')),
                ('managed_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='persons', to=settings.AUTH_USER_MODEL, verbose_name='Managed by')),
            ],
            options={
                'verbose_name': 'Person',
